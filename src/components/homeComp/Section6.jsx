  ...
  return (
    <div className="sub-section w-[100%] h-70 flex flex-col items-center justify-center mt-5">
        ...
        <div className='flex flex-col justify-center items-center -mt-15'>
            ...
            <p className="text-gray-300">Stay updated with the latest coffee trends and exclusive offers.</p>
            <div className='mt-4'>
                <form>
                    <input className='bg-zinc-100 px-6 py-3 w-80' type="text" placeholder='Enter your mail' />
                    <button className='bg-amber-500 px-4 py-3'>Subscribe</button>
                </form>
            </div>
        </div>
    </div>
